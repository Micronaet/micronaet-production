...
class SaleOrder(orm.Model):
    ...
    def _recreate_production_sol_move(
            self, cr, uid, sol_ids, context=None):
        ...
        move_pool.create(cr, uid, {
            ...
            # 'warehouse_id', 'picking_type_id',
            # 'weight' 'weight_net' 'picking_id' 'group_id'
            # 'production_id' 'product_packaging' 'company_id'
            # 'date': 'date_expected' 'note':, 'partner_id':
            # 'price_unit', 'priority',.
            }, context=context)
